                    ...
                    <div class="card-body">
                        <a href="../siswa/" class="">
                            <div class="row alig n-items-start">
                                <div class="col-8">
                                    <?php 
                                $countsiswa = mysqli_query($con, "SELECT COUNT(*) as total FROM siswa");
                                $siswacount = mysqli_fetch_assoc($countsiswa);
                                ?>
                                    <h5 class="card-title mb-9 fw-semibold">Total<br> Anggota</h5>
                                    <h4 class="fw-semibold mb-3"><?= $siswacount['total']?></h4>
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal"><?= substr($siswa['address'], 0, 40) . '...' ?></p>
                                </td>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0 fs-4"><?= $siswa['fullname'] ?></h6>
                                </td>
                                <td class="border-bottom-0">
